    ...
    return(
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark mb-3">
            <div className="container-fluid">
                <a className="navbar-brand" href="#"><img className="logo" src="https://dt1creuksls0v.cloudfront.net/static/assets/img/svg/logo-min.svg"/></a>
                <p className="text-white m-0">CRM Workflow</p>
